                ...
                script {
                    ...
                    if (allTaskIds) {
                        allTaskIds.each { taskId ->
                            ...
                            build job: 'rawhide-installability-pipeline', wait: false, parameters: [ string(name: 'ARTIFACT_ID', value: artifactId), string(name: 'ADDITIONAL_ARTIFACT_IDS', value: additionalArtifactIds) ]
                        }
                    }
                }
            }
